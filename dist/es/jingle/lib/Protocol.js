...
export function convertIntermediateToTransport(media) {
...
export function convertIntermediateToRequest(session, role) {
    return {
...
export function convertIntermediateToTransportInfo(mid, candidate) {
    return {
        contents: [
            {
                creator: SessionRole.Initiator,
