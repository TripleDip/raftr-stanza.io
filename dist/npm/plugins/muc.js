...
function default_1(client) {
    client.disco.addFeature(protocol_1.Namespaces.MUC);
    client.disco.addFeature(protocol_1.Namespaces.MUC_DIRECT_INVITE);
    client.disco.addFeature(protocol_1.Namespaces.HATS_0);
    client.joinedRooms = {};
    client.joiningRooms = {};
    ...
    client.changeNick = function (room, nick) {
        client.sendPresence({
            to: new jid_1.JID(room).bare + '/' + nick
        });
    };
