            ...
            (u.prototype.slice = function(e, t) {
                ...
                (u.prototype.fill = function(e, t, n, i) {
                    ...
                    if (
                        ...
                        var o = u.isBuffer(e) ? e : U(new u(e, i).toString()),
                            a = o.length;
...
***************************************************************************** */
            ...
            (n.mixin = function(e) {
                ...
                (t.isWildEmitter = !0),
                    ...
                    (t.once = function(e, t, n) {
                        ...
                        function a() {
                            i.off(e, a), o.apply(this, arguments);
                        }
                        return this.on(e, s, a), this;
                    }),
                    ...
                    (t.off = function(e, t) {
                        ...
                        return i
                            ? 1 === arguments.length
                                ...
                                : (-1 !== (n = i.indexOf(t)) &&
                                      (i.splice(n, 1), 0 === i.length && delete this.callbacks[e]),
                                  this)
                            : this;
                    }),
                    (t.emit = function(e) {
    ...
    function(e, t, n) {
        ...
        (function(e, i, r) {
            ...
            const s = n(8),
                o = n(39),
                a = s.__importDefault(n(42)),
                u = s.__importDefault(n(11)),
                c = n(51),
                l = n(8),
                f = s.__importDefault(n(72)),
                d = n(73),
                h = n(6),
                p = n(35),
                m = n(74);
            ...
            class M {
                constructor(e) {
                    (e = e || {}), (this._genNonce = e.genNonce || B);
                }
                response(e) {
            ...
            (M.prototype.name = 'DIGEST-MD5'), (M.prototype.clientFirst = !1);
            const D = {};
            function N(e) {
                const t = [];
                let n = '';
            ...
            (Q.prototype.name = 'X-OAUTH2'), (Q.prototype.clientFirst = !0);
            class Y {
                constructor() {
                    this._mechs = [];
                }
            ...
            const G = 'urn:ietf:params:xml:ns:xmpp-bind',
                $ = 'jabber:client',
                H = 'urn:ietf:params:xml:ns:xmpp-sasl',
                X = 'jabber:server',
                ...
                Be = 'http://jabber.org/protocol/shim',
                Me = 'http://jabber.org/protocol/xdata-layout',
                De = 'urn:xmpp:reach:0',
                ...
                Qe = 'urn:xmpp:jingle:apps:rtp:1',
                Ye = 'urn:xmpp:jingle:apps:rtp:info:1',
                Ge = 'urn:xmpp:jingle:apps:rtp:audio',
                $e = 'urn:xmpp:jingle:apps:rtp:video',
                He = 'http://jabber.org/protocol/nick',
                Xe = 'urn:xmpp:jingle:transports:ice-udp:1',
            ...
            function Ut(e) {
                const t = e.utils,
                    n = e.define({
                        element: 'bind',
                        fields: { jid: t.jidSub(G, 'jid'), resource: t.textSub(G, 'resource') },
                        name: 'bind',
                        namespace: G
                    });
            ...
            const Ht = ['next', 'prev', 'complete', 'cancel'],
                Xt = [
                    'bad-action',
                    'bad-locale',
                    'bad-payload',
            ...
            function Kt(e) {
                ...
                e.extend(n, i, 'notes'),
                    ...
                    e.withStanzaError(function(n) {
                        e.add(n, 'adhocCommandCondition', t.enumSub(pe, Xt));
                    }),
                    ...
                    l = {
                        ...
                        set: function(e) {
                            for (let n = 0, i = e.length; n < i; n++) {
                                const i = e[n];
                                if (i.text) {
                                    const e = t.createElement(Me, 'text', Me);
                                    (e.textContent = i.text), this.xml.appendChild(e);
                                }
                                if (i.field) {
                                    const e = t.createElement(Me, 'fieldref', Me);
                                    e.setAttribute('var', i.field), this.xml.appendChild(e);
                                }
                                if (
                                    (i.reported &&
                                        this.xml.appendChild(
                                            t.createElement(Me, 'reportedref', Me)
                                        ),
                                    i.section)
                                ) {
                                    const e = t.createElement(Me, 'section', Me);
            ...
            function yn(e) {
                const t = e.utils,
                    n = e.define({
                        element: 'transport',
                        fields: {
                            gatheringComplete: t.boolSub(Xe, 'gathering-complete'),
                            pwd: t.attribute('pwd'),
            ...
            const Cn = {};
            function Rn(e) {
                Cn.defineMessage(e, 'message', $),
                    Cn.defineMessage(e, 'serverMessage', X),
                                ...
                                t.setAttribute('type', e.type),
                                    ...
                                    e.url
                                        ? (n.appendChild(s),
                                          ...
                                          t.appendChild(r),
                                          this.xml.appendChild(t))
                                        : e.pk && (t.appendChild(o), this.xml.appendChild(t));
                            }
                        },
            ...
            function Mn(e) {
                const t = e.utils.textSub(He, 'nick');
                e.withPubsubItem(function(n) {
                    e.add(n, 'nick', t);
                }),
                    e.withPresence(function(n) {
            ...
            const Fn = {};
            function Un(e) {
                Fn.definePresence(e, 'presence', $),
                    Fn.definePresence(e, 'serverPresence', X),
            ...
            const Qn = ['server-unavailable', 'connection-paused'];
            function Yn(e) {
                const t = e.define({
                    element: 'state-annotation',
                    fields: {
                        condition: e.utils.enumSub(xt, Qn),
            ...
            function Hn(e) {
                e.withStanzaError(function(t) {
                    e.add(t, 'pubsubCondition', e.utils.enumSub(ye, $n)),
                ...
                const t = e.utils,
                    n = {
                        ...
                        set: function(e) {
                            ...
                            for (const i of e) {
                                let e;
                                'trr-int' === i.type
                                    ? ((e = t.createElement(dt, 'rtcp-fb-trr-int', Qe)),
                                      t.setAttribute(e, 'type', i.type),
                                      t.setAttribute(e, 'value', i.value))
                                    : ((e = t.createElement(dt, 'rtcp-fb', Qe)),
                                      t.setAttribute(e, 'type', i.type),
                    ...
                    r = e.define({
                        ...
                        fields: {
                            ...
                            encryption: {
                                get: function() {
                                    let e = t.find(this.xml, Qe, 'encryption');
                                    if (!e.length) return [];
                                    e = e[0];
                                    const n = this,
                                        i = t.find(e, Qe, 'crypto'),
                                        r = [];
                                    for (const e of i) r.push(new o({}, e, n).toJSON());
                                    return r;
                                },
                                set: function(e) {
                                    let n = t.find(this.xml, Qe, 'encryption');
                                    ...
                                    t.setBoolSubAttribute(
                                        ...
                                        (n = t.find(this.xml, Qe, 'encryption')[0]);
                                    const i = this;
                                    for (const t of e) {
                            ...
                            headerExtensions: {
                                ...
                                set: function(e) {
                                    ...
                                    for (const e of i) n.xml.removeChild(e);
                                    for (const i of e) {
                                        const e = t.createElement(ht, 'rtp-hdrext', Qe);
                            ...
                            mux: t.boolSub(Qe, 'rtcp-mux'),
                            reducedSize: t.boolSub(Qe, 'rtcp-rsize'),
                    ...
                    s = e.define({
                        ...
                        fields: {
                            ...
                            parameters: {
                                get: function() {
                                    const e = [],
                                        n = t.find(this.xml, Qe, 'parameter');
                                    for (const i of n)
                                        e.push({
                                ...
                                set: function(e) {
                                    const n = this;
                                    for (const i of e) {
                                        const e = t.createElement(Qe, 'parameter');
                ...
                e.extend(r, i),
                    ...
                    e.withDefinition('jingle', Ue, function(n) {
                        e.extend(n, f),
                            e.extend(n, d),
                            e.extend(n, a, 'groups'),
                            e.add(n, 'ringing', t.boolSub(Ye, 'ringing')),
                            e.add(n, 'hold', t.boolSub(Ye, 'hold')),
                            e.add(n, 'active', t.boolSub(Ye, 'active'));
                    });
            }
            ...
            function ai(e) {
                const t = e.utils,
                    n = e.define({
                        element: 'mechanisms',
                        fields: { mechanisms: t.multiTextSub(H, 'mechanism') },
                        name: 'sasl',
                        namespace: H
                    });
                e.define({
                    ...
                    e.define({
                        ...
                        fields: {
                            $text: {
                                get: function() {
                                    return t.getSubLangText(this.xml, H, 'text', this.lang);
                                }
                            },
                            condition: t.enumSub(H, oi),
                            lang: {
                                get: function() {
                                    return this._lang || '';
                                },
                            ...
                            text: {
                                ...
                                set: function(e) {
                                    t.setSubLangText(this.xml, H, 'text', e, this.lang);
                                }
                            }
                        },
                        name: 'saslFailure',
            ...
            function ci(e) {
                const t = e.utils,
                    n = {
                        get: function() {
                            const e = t.find(this.xml, Be, 'headers');
                            return e.length
                                ? t.getMultiSubText(e[0], Be, 'header', function(e) {
                        ...
                        set: function(n) {
                            const i = t.findOrCreate(this.xml, Be, 'headers');
                            e.setMultiSubText(i, Be, 'header', n, function(e) {
                                const n = t.createElement(Be, 'header', Be);
            ...
            const wi = { client: $, component: Ce, server: X };
            function _i(e) {
                (e.extendMessage = function(e, t) {
                    ...
                    (e.withIQ = function(e) {
                        this.withDefinition('iq', $, e), this.withDefinition('iq', Ce, e);
                    }),
                    (e.withMessage = function(e) {
                        this.withDefinition('message', $, e), this.withDefinition('message', Ce, e);
                    }),
                    (e.withPresence = function(e) {
                        this.withDefinition('presence', $, e),
                    ...
                    (e.withStanzaError = function(e) {
                        this.withDefinition('error', $, e), this.withDefinition('error', Ce, e);
                    }),
            ...
            let Mi = n(76);
            'function' != typeof Mi && (Mi = window.WebSocket);
            const Di = 1;
            class Ni extends u.default {
                ...
                connect(t) {
                    ...
                    (n.config = t),
                        (n.hasStream = !1),
                        (n.closing = !1),
                        (n.conn = new Mi(t.wsURL, 'xmpp', t.wsOptions)),
            ...
            function $i(e) {
                (e.disco = new Gi(e)),
                    ...
                    (e.verifyVerString = Yi),
                    (e.generateVerString = Qi),
                    e.updateCaps();
            }
            function Hi(e) {
                e.disco.addFeature('jid\\20escaping'),
                    ...
                    e.disco.addFeature(`${Be}#SubID`, Be);
                const t = c.getHashes();
                ...
                for (const n of e.media || []) {
                    ...
                    if ('application' === n.kind && n.sctp) t.push(wr(n, n.sctp));
                        ...
                        if (
                            ...
                            (t.push(
                                `a=ssrc:${n.rtcpParameters.ssrc} cname:${n.rtcpParameters.cname}\r\n`
                            ),
            ...
            function Gr(e) {
                e.disco.addFeature(He),
                    e.disco.addFeature(Fe(He)),
                    e.on('pubsub:event', function(t) {
                        t.event.updated &&
                            t.event.updated.node === He &&
                            e.emit('nick', {
                                jid: t.from,
                    ...
                    (e.publishNick = function(e, t) {
                        return this.publish('', He, { nick: e }, t);
                    });
            }
            function $r(e) {
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 });
        const i = n(8),
            r = i.__importStar(n(43)),
            s = i.__importStar(n(10)),
            o = i.__importDefault(n(50));
        class a {
            constructor() {
                (this._LOOKUP = {}),
                    (this._LOOKUP_EXT = {}),
                    ...
                    (this._CB_TAG = {}),
                    (this._ID = Symbol('JXT')),
                    (this.utils = Object.assign({}, r, s));
            }
            use(e) {
                return e && 'function' == typeof e
                    ? (e[this._ID] || (e(this), (e[this._ID] = !0)), this)
                    : this;
            }
            getDefinition(e, t, n) {
            ...
            extend(e, t, n, i) {
                const s = e.prototype._NS + '|' + e.prototype._EL,
                    o = t.prototype._name,
                    a = t.prototype._NS + '|' + t.prototype._EL;
                (this._LOOKUP[a] = t),
                    this._LOOKUP_EXT[a] || (this._LOOKUP_EXT[a] = {}),
                    this._LOOKUP_EXT[s] || (this._LOOKUP_EXT[s] = {}),
                    (this._LOOKUP_EXT[s][o] = t),
                    (!n || (n && !i)) && this.add(e, o, r.extension(t)),
                    n && this.add(e, n, r.multiExtension(t));
            }
            add(e, t, n) {
            ...
            define(e) {
                ...
                return (
                    ...
                    this._CB_DEFINITION[a] &&
                        this._CB_DEFINITION[a].forEach(function(e) {
                            e(n);
                        }),
                    s.forEach(function(e) {
                        t._CB_TAG[e] &&
    ...
    function(e, t, n) {
            ...
            (function(t) {
                ...
                var K = Object.prototype,
                    ...
                    J = X(
                        ...
                        ? X
                        : function(e) {
                              return $(e) && W.call(e, 'callee') && !V.call(e, 'callee');
                          },
                    Z = Array.isArray,
                ...
                function Ae(e) {
                    return function(t, n, i) {
                        if (((i = Q(i || z)), e <= 0 || !t)) return i(null);
                        var r = _e(t),
                            s = !1,
                            o = 0,
                            a = !1;
                ...
                var Ye = function(e, t, n) {
                    'function' == typeof t && ((n = t), (t = null)), (n = Q(n || z));
                    var i = we(e).length;
                    if (!i) return n(null);
                    t || (t = i);
                    var r = {},
                ...
                var $e = '[object Symbol]',
                    He = 1 / 0,
                    Xe = A ? A.prototype : void 0,
                    Ke = Xe ? Xe.toString : void 0;
                function We(e) {
                    if ('string' == typeof e) return e;
                    if (Z(e)) return Ge(e, We) + '';
                    if (
                        (function(e) {
                            return 'symbol' == typeof e || ($(e) && O(e) == $e);
                        })(e)
                    )
                        return Ke ? Ke.call(e) : '';
                    var t = e + '';
                    return '0' == t && 1 / e == -He ? '-0' : t;
                }
                function Ve(e, t, n) {
                    var i = e.length;
                    return (
                ...
                function ft(e, t, n) {
                    ...
                    return Ve(
                        r,
                        (function(e, t) {
                            for (var n = -1, i = e.length; ++n < i && Qe(t, e[n], 0) > -1; );
                            return n;
                        })(r, s),
                        (function(e, t) {
                            for (var n = e.length; n-- && Qe(t, e[n], 0) > -1; );
                            return n;
                        })(r, s) + 1
                    ).join('');
                }
                ...
                function gt(e, t) {
                    ...
                    Ue(e, function(e, t) {
                        var i,
                            r = y(e),
                            s = (!r && 1 === e.length) || (r && 0 === e.length);
                        if (Z(e))
                            (i = e.slice(0, -1)),
                                (e = e[e.length - 1]),
                                (n[t] = i.concat(i.length > 0 ? o : e));
                        else if (s) n[t] = e;
                        else {
                            if (
                                ((i = (function(e) {
                                    return (e = (e = (e = (e = e.toString().replace(mt, ''))
                                        .match(dt)[2]
                                        .replace(' ', ''))
                                        ? e.split(ht)
                                        : []).map(function(e) {
                                ...
                                0 === e.length && !r && 0 === i.length)
                            )
                                throw new Error(
                                    'autoInject task functions require explicit parameters.'
                                );
                            r || i.pop(), (n[t] = i.concat(o));
                        }
                        function o(t, n) {
                            var r = Ge(i, function(e) {
                                return t[e];
                            });
        ...
        }.call(this, n(28).setImmediate, n(4), n(3), n(34)(e)));
    },
    function(e, t, n) {
        (function(e, i) {
            var r;
